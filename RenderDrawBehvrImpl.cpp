...
void Render::FBOdraw()
{
	...
	case  FBO_ALL_VIEW_MODE:
		...
		RenderRightPanoView(env,0,g_windowHeight*864.0/1080.0,g_windowWidth, g_windowHeight*216.0/1080.0,0,0,0,0,needSendData);
		gettimeofday(&startT[5],0);

		RenderLeftPanoView(env,0,g_windowHeight*648.0/1080.0,g_windowWidth, g_windowHeight*216.0/1080.0,needSendData);
