...
FboManger::FboManger(int TextureW,int TextureH,GLuint rboCid,GLuint rboDid,
		GLuint fboid,GLMatrixStack &modelViewMat,GLMatrixStack	&projectionMat,GLShaderManager* mgr):fboSupported(false),fboUsed(false),
				TextureHeight(TextureH),TextureWidth(TextureW),
				rboColorId(rboCid),rboDepthId(rboDid),fboId(fboid),
...
///////////////////////////////////////////////////////////////////////////////
std::string  FboManger::convertInternalFormatToString(GLenum format)
{
...
///////////////////////////////////////////////////////////////////////////////
std::string  FboManger::getTextureParameters(GLuint id)
{
...
///////////////////////////////////////////////////////////////////////////////
std::string  FboManger::getRenderbufferParameters(GLuint id)
{
...
///////////////////////////////////////////////////////////////////////////////
bool FboManger::checkFramebufferStatus(GLuint fbo)
{
    // check FBO status
...
///////////////////////////////////////////////////////////////////////////////
void FboManger::printFramebufferInfo(GLuint fbo)
{
    // bind fbo
...
bool FboManger::IsInitOK()
{
    ...
    if(fboSupported)
    {
        ...
        glBindRenderbuffer(GL_DRAW_FRAMEBUFFER, rboDepthId);
        glRenderbufferStorage(GL_DRAW_FRAMEBUFFER, GL_DEPTH_COMPONENT32, TextureWidth, TextureHeight);
 //       glRenderbufferStorage(GL_RENDERBUFFER, GL_DEPTH_COMPONENT, 1920, 1080);
     ...
     //   glBindRenderbuffer(GL_RENDERBUFFER, 0);
        ...
        glFramebufferRenderbuffer(GL_DRAW_FRAMEBUFFER, GL_DEPTH_ATTACHMENT, GL_RENDERBUFFER, rboDepthId);
...
void FboManger::InitScreenQuad_Matrix(int imageWidth,int imageHeight)
{
...
*/
		m_pShaderManager->UseStockShader(GLT_SHADER_TEXTURE_REPLACE,render.getTransformPipeline()->GetModelViewProjectionMatrix(),textureId );// VGA texture start from 15
	...
	//	glBindTexture(GL_TEXTURE_2D, 2);
		...
		m_pShaderManager->UseStockShader(GLT_SHADER_TEXTURE_RECT_REPLACE,render.getTransformPipeline()->GetModelViewProjectionMatrix(),textureId );

//		m_pShaderManager->UseStockShader(GLT_SHADER_TEXTURE_RECT_REPLACE,render.getTransformPipeline()->GetModelViewProjectionMatrix(),textureId );
//		m_pShaderManager->UseStockShader(GLT_SHADER_TEXTURE_MODULATE,render.getTransformPipeline()->GetModelViewProjectionMatrix(), vWhite, 0);
		screenQuad.Draw();
...
void FboManger::ChangeSize(int screenWidth, int screenHeight)
{
	InitScreenQuad_Matrix(screenWidth, screenHeight);
