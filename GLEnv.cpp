...
PBORulerSmallMgr(PBOSender(MAGICAL_NUM+ICON_COUNT,RULER_WIDTH_2,RULER_HEIGHT_2,iniCC,iniformat)),//图片
...
PBOSender *GLEnv::Getp_PBORulerSmallMgr()
{
	return 	&	 PBORulerSmallMgr;
}
